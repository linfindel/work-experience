...
const apiKey = "eyJ4NXQiOiJOak16WWpreVlUZGlZVGM0TUdSalpEaGtaV1psWWpjME5UTXhORFV4TlRZM1ptRTRZV1JrWWc9PSIsImtpZCI6ImdhdGV3YXlfY2VydGlmaWNhdGVfYWxpYXMiLCJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..cdV7UHoYvHFrBq5HPqK7N5K0jacXn9uAZYNgV-VpBsSc_RiciEhTgFlHIKJS4JmW2unyYsiE7npLPz471efkrUzUoJmp7GDqSwz8LecL5bEzERA9_RlJt8N7iDLMBO2MNxZYsALQdqwRNOz0kSQKsBe_61oHQQNvc8eCD1Mhjbokywgy47VL30-Ajm2nAImgAxUl-EQIaouOXzEBlUxUUZl6zKRhj3F90CKFFBGzAWfDKeoMkDpI9xwa_mJlpBx4OIwrdsV_T0Aj61_DIyBIwbb-I7KxLDB1I3H1HBq-swV5vbLArXnrO-fM5omNCnCcJtfCEwH3bBiOfb0_s2Yg_A==";
...
function fetchData() {
  ...
  .then(data => {
    ...
    for (let index = 1; index <= 8; index++) {
      ...
      let date = data.features[0].properties.timeSeries[index].time.replace("T00:00Z", "");
      ...
      document.getElementById(`day${index}-date`).innerText = `${day}/${month}/${year}`;
    }
  })
}
